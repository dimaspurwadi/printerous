    ...
    <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex flex-column">
                <!--begin::Title-->
                <h2 class="text-white font-weight-bold my-2 mr-5">User Management</h2>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <div class="d-flex align-items-center font-weight-bold my-2">
                    ...
                    <a href="{{ route('user.index') }}" class="text-white text-hover-white opacity-75 hover-opacity-100">List User</a>
                    <!--end::Item-->
                </div>
                <!--end::Breadcrumb-->
            </div>
        ...
        <div class="card card-custom">
            ...
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <div class="card-toolbar">
                    <a href="{{ route('user.form', ['id' => 0]) }}" class="btn btn-primary font-weight-bolder">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('body').on('click', '.delete', function(){
            var id = this.id;
            var name = this.name;
            var url = "{{route('user.view.delete')}}";
            var data={
                id: id,
                name: name, 
                _token : '{{csrf_token()}}'
