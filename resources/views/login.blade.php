				...
				<div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('assets/media/bg/bg-3.jpg');">
					<div class="login-form text-center p-7 position-relative overflow-hidden">
						...
						<div class="d-flex flex-center mb-15">
							<a href="#">
								<img src="assets/media/logos/stars.png" class="max-h-75px" alt="" />
							</a>
						</div>
						<!--end::Login Header-->
						...
						<div class="login-signin">
							...
							<form class="form" action="{{route('submit-login')}}" method="post">
								...
								<div class="form-group mb-5">
									<input class="form-control h-auto form-control-solid py-4 px-8" type="text" placeholder="Email" id="email" name="email" autocomplete="off" value="{{ old('email') }}"  required/>
								</div>
								<div class="form-group mb-5">
									<input class="form-control h-auto form-control-solid py-4 px-8" type="password" placeholder="Password" id="password" name="password" required/>
								</div>
